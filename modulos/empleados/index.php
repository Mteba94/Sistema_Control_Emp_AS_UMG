...
$sentencia = $conexion->prepare("SELECT *,(SELECT nombre_puesto FROM tbl_puestos WHERE tbl_puestos.id_puesto=tbl_empleados.id_puesto limit 1) as puesto FROM `tbl_empleados`");
//EJECUTO EL QUERY
$sentencia->execute();

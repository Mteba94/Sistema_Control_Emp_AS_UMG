...
if (isset($_GET['txtID'])) {
	...
	$sentencia = $conexion->prepare("SELECT * FROM tbl_puestos WHERE id_puesto=:id");
...
if ($_POST) {
	...
	//SENTECIA SQL
	$sentencia = $conexion->prepare("UPDATE tbl_puestos SET nombre_puesto=:nombrePuesto WHERE id_puesto=:id");
